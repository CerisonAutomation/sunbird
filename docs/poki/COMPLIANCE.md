...
**Result:** ❌ 12 problem(s) · 92/118 rules verified · 77 of them hard requirements.
...
- EA-02: "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals.
- TOOL-02: "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip.
- TOOL-03: "node scripts/verify-upload.mjs" failed: ✓ ROOT-04 poki-upload/ holds 14 files, none of them junk / ✓ ROOT-06 all 2 local asset references resolve inside poki-upload/ / ✗ ROOT-07 foreign portal marker in poki-upload/ — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName" / ✓ ROOT-08 poki-upload/ keeps Poki's own integrations (Netlib P2P · AUDS · SDK) /  / ✗ 1 upload gate failure(s) — poki-upload/index.html 1.89 MB, at the folder root.
- REQ-04: "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals.
- REQ-05: "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals.
- REQ-20: "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals.
- REQ-22: "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip.
- REQ-24: "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals.
- REQ-31: cannot execute: sunbird-crazy.zip, sunbird-generic.zip missing — run pnpm build:portals first
- REQ-35: "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip.
- REQ-51: "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip.
- REQ-63: "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals.
...
| `EA-02` | requirement | Keep it small: target an 8–10 MB game file for older hardware and slow connections. | ❌ | "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals. |
...
| `TOOL-02` | requirement | The build must survive the Inspector's mobile and technical-optimisation passes (no external resources, no console errors, sane image weights). | ❌ | "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip. |
| `TOOL-03` | requirement | Uploadable as a folder with index.html at the root, working from any sub-path. | ❌ | "node scripts/verify-upload.mjs" failed: ✓ ROOT-04 poki-upload/ holds 14 files, none of them junk / ✓ ROOT-06 all 2 local asset references resolve inside poki-upload/ / ✗ ROOT-07 foreign portal marker in poki-upload/ — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName" / ✓ ROOT-08 poki-upload/ keeps Poki's own integrations (Netlib P2P · AUDS · SDK) /  / ✗ 1 upload gate failure(s) — poki-upload/index.html 1.89 MB, at the folder root. |
...
| `REQ-04` | requirement | Initial download under ~5 MB, total under ~8 MB. | ❌ | "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals. |
| `REQ-05` | requirement | No service worker or manifest inside portal builds. | ❌ | "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals. |
...
| `REQ-20` | requirement | No in-app purchases on the platform and no UI implying them. | ❌ | "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals. |
| `REQ-21` | requirement | No secondary spendable currencies. | ✅ | src/game/__tests__/economy.test.ts |
| `REQ-22` | requirement | No third-party ad systems. | ❌ | "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip. |
| `REQ-23` | requirement | No ad-timer or cooldown manipulation. | ✅ | src/game/Game.ts matches /portalEnabled\(\)/ |
| `REQ-24` | requirement | External links only through the platform API; portal builds should have none. | ❌ | "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals. |
...
| `REQ-31` | requirement | No chat in multiplayer surfaces; emotes are the recommended alternative. | ❌ | cannot execute: sunbird-crazy.zip, sunbird-generic.zip missing — run pnpm build:portals first |
...
| `REQ-35` | recommendation | External resources policy: prefer zero external requests; bundle assets and avoid CDNs. | ❌ | "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip. |
...
| `REQ-51` | requirement | The submitted build is web-exclusive: no store build that double-serves the Poki artifact. | ❌ | "node scripts/audit-zips.mjs" failed: ❌ AUDIT FAILED /   ✗ crazy: zip missing — run `pnpm build:portals` first. /   ✗ generic: zip missing — run `pnpm build:portals` first. /   ✗ poki: index.html missing from zip. /   ✗ poki: only 0 icon files in zip. /   ✗ poki: only 0 font files in zip. |
...
| `REQ-63` | requirement | Portal bundles must contain no ad-removal copy and no free-text name field (bundle-level enforcement of REQ-20 and the player-safety policy). | ❌ | "node scripts/verify-portal.mjs" failed: ✓ sunbird-poki.zip  889 KB  1940 KB html /  / ❌ PORTAL GATE FAILED / poki: foreign portal marker in bundle — free-text pilot name input (no player-authored text or personal data on portals): "data-ref="pilotName". / crazy: zip missing — run pnpm build:portals. / generic: zip missing — run pnpm build:portals. |
