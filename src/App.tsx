...
export default function App() {
  ...
  // Audio muting during ad breaks — both platforms require it
  const onAdOpened = () => {
    document.dispatchEvent(new CustomEvent("sunbird-ad-open"));
  };
  const onAdClosed = () => {
    document.dispatchEvent(new CustomEvent("sunbird-ad-close"));
  };

  const platform = usePlatform(onAdOpened, onAdClosed);
