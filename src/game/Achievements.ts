...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: "perfect_10", title: "Perfectionist", desc: "10 perfect launches", rarity: "bronze", target: 10, metric: (s) => s.state.bestCombo || 0 },
  { id: "perfect_50", title: "Golden Touch", desc: "50 perfect launches", rarity: "silver", target: 50, metric: (s) => s.state.bestCombo || 0 },
  { id: "perfect_200", title: "Flawless", desc: "200 perfect launches", rarity: "gold", target: 200, metric: (s) => s.state.bestCombo || 0 },
  ...
  { id: "speed_80", title: "Speed Demon", desc: "Reach 80 km/h in flight", rarity: "bronze", target: 80, metric: (s) => s.state.bestDistance || 0 },
  ...
  { id: "combo_5", title: "Chain Master", desc: "5x launch combo", rarity: "silver", target: 5, metric: (s) => s.state.bestCombo || 0 },
  { id: "combo_10", title: "Combo King", desc: "10x launch combo", rarity: "gold", target: 10, metric: (s) => s.state.bestCombo || 0 },
  { id: "fever_10", title: "Fever Pitch", desc: "Enter fever 10 times", rarity: "bronze", target: 10, metric: (s) => s.state.lifetime.ghostBeats || 0 },
  { id: "fever_50", title: "Fever Master", desc: "Enter fever 50 times", rarity: "gold", target: 50, metric: (s) => s.state.lifetime.ghostBeats || 0 },
  { id: "coins_50", title: "Coin Collector", desc: "50 coins in one flight", rarity: "bronze", target: 50, metric: (s) => s.state.bestDistance || 0 },
  { id: "coins_200", title: "Coin Hoarder", desc: "200 coins in one flight", rarity: "silver", target: 200, metric: (s) => s.state.bestDistance || 0 },
  ...
  { id: "trails_5", title: "Trail Blazer", desc: "Own 5 trail types", rarity: "silver", target: 5, metric: (s) => s.state.ownedSkins.length },
  { id: "races_50", title: "Racing Legend", desc: "Complete 50 races", rarity: "gold", target: 50, metric: (s) => s.state.runsPlayed },
  { id: "wins_10", title: "Champion", desc: "Win 10 ranked races", rarity: "gold", target: 10, metric: (s) => s.state.runsPlayed },
  { id: "division_legend", title: "Sunbird Legend", desc: "Reach Legend division", rarity: "platinum", target: 1550, metric: (s) => s.state.runsPlayed },
];
