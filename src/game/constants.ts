...
export const MULTIPLAYER_WS_URL = import.meta.env.VITE_MULTIPLAYER_WS_URL ?? "";
export const GLOBAL_LB_ENDPOINT = import.meta.env.VITE_GLOBAL_LB_ENDPOINT ?? "";
export const STRIPE_RETURN_KEY = "sunbird_stripe";

export const VIP_DAYS = 30;

/* ---------- Ad monetization (optimal for Poki/CrazyGames) ---------- */
export const ADS_PER_DAY = 6; // Increased from 4 — SDK handles pacing
export const AD_MIN_RUN_GAP = 1; // Reduced from 2 — SDK auto-throttles to max 1 every 3 min
// AD_DURATION already exported above (= 4)
export const REWARDED_COIN_MULTIPLIER = 2; // 2x coins for watching rewarded ad
export const REWARD_VIDEO_ICON = "🎬"; // Industry standard video icon for rewarded buttons

/* ---------- Season pass ---------- */
export const SEASON_TIERS = 20;
export const SEASON_XP_PER_TIER = 520; // Doubled from 260 — ~42 runs to complete monthly season
export const VIP_DAILY_GIFT = 25;

/** Generate a season ID from a date (YYYY-MM format). */
